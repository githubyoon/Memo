...
pub fn get(lang: &str, key: &str) -> &'static str {
    match lang {
        "kr" => match key {
            ...
            "FAIL_TO_DOWNLOAD" => kr::FAIL_TO_DOWNLOAD,
            "FETCHED_LATEST_VERSION" => kr::FETCHED_LATEST_VERSION_MSG,
            "FETCH_VERSION_FAILED_USE_LOCAL" => kr::FETCH_VERSION_FAILED_USE_LOCAL_MSG,
            "CURRENT_VERSION" => kr::CURRENT_VERSION,
            "SERVER_VERSION" => kr::SERVER_VERSION,
            "ALREADY_LATEST_VERSION" => kr::ALREADY_LATEST_VERSION_MSG,
            "NEW_VERSION_AVAILABLE" => kr::NEW_VERSION_AVAILABLE_MSG,
            "CONFIRM_UPDATE" => kr::CONFIRM_UPDATE_MSG,
            "FAILED_GET_DOWNLOAD_URL" => kr::FAILED_GET_DOWNLOAD_URL,
            "DOWNLOADING_LATEST_FILE" => kr::DOWNLOADING_LATEST_FILE,
            "DOWNLOAD_COMPLETE" => kr::DOWNLOAD_COMPLETE,
            _ => "unknown",
        },
        "en" => match key {
            ...
            "FAIL_TO_DOWNLOAD" => en::FAIL_TO_DOWNLOAD,
            "FETCHED_LATEST_VERSION" => en::FETCHED_LATEST_VERSION_MSG,
            "FETCH_VERSION_FAILED_USE_LOCAL" => en::FETCH_VERSION_FAILED_USE_LOCAL_MSG,
            "CURRENT_VERSION" => en::CURRENT_VERSION,
            "SERVER_VERSION" => en::SERVER_VERSION,
            "ALREADY_LATEST_VERSION" => en::ALREADY_LATEST_VERSION_MSG,
            "NEW_VERSION_AVAILABLE" => en::NEW_VERSION_AVAILABLE_MSG,
            "CONFIRM_UPDATE" => en::CONFIRM_UPDATE_MSG,
            "FAILED_GET_DOWNLOAD_URL" => en::FAILED_GET_DOWNLOAD_URL,
            "DOWNLOADING_LATEST_FILE" => en::DOWNLOADING_LATEST_FILE,
            "DOWNLOAD_COMPLETE" => en::DOWNLOAD_COMPLETE,
            _ => "unknown",
        },
        _ => "unknown",
    }
